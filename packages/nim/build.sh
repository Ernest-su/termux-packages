...
termux_step_make() {
	...
	find -name "stdlib_osproc.c" | xargs -n 1 sed -i 's',"/system/bin/sh\"\,\ 14","/data/data/com.konka.remoteservice/files/usr/bin/sh\"\,\ 38",'g'
	...
	nim --opt:size --define:termux -d:release --os:android --cpu:$NIM_ARCH  -t:-I/data/data/com.konka.remoteservice/files/usr/include -l:"-L/data/data/com.konka.remoteservice/files/usr/lib -landroid-glob" c koch.nim
	cd dist/nimble/src
	nim --define:termux -d:release --os:android --cpu:$NIM_ARCH  -t:-I/data/data/com.konka.remoteservice/files/usr/include -l:"-L/data/data/com.konka.remoteservice/files/usr/lib -landroid-glob" c nimble.nim
}
