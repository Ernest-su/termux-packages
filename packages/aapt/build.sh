...
termux_step_make_install() {
	...
	# /data/data/com.konka.remoteservice/files/usr/include/aosp/cutils/properties.h:116:45: error: expected identifier
	# __errordecl(__property_get_too_small_error, "property_get() called with too small of a buffer");
	#						^
	# /data/data/com.konka.remoteservice/files/usr/include/aosp/cutils/properties.h:119:5: error: static declaration of 'property_get' follows non-static declaration
	# int property_get(const char *key, char *value, const char *default_value) {
	#	^
	# /data/data/com.konka.remoteservice/files/usr/include/aosp/cutils/properties.h:46:5: note: previous declaration is here
	# int property_get(const char *key, char *value, const char *default_value);
